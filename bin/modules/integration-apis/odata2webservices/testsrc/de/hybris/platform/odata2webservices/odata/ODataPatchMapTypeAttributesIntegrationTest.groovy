...
class ODataPatchMapTypeAttributesIntegrationTest extends ServicelayerSpockSpecification {
    ...
    private static final def TEST_NAME = 'ODataPatchMapTypeAttributes'
    private static final String TEST_IO = "${TEST_NAME}_SchemaWithMapsIO"
    private static final def CATALOG = "${TEST_NAME}_Test"
    private static final def VERSION = 'V1'
    private static final def PRODUCT_CODE = "${TEST_NAME}_testProdA"
