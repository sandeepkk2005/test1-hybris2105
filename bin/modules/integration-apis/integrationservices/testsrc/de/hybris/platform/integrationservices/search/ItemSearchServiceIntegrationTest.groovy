...
class ItemSearchServiceIntegrationTest extends ServicelayerSpockSpecification {
    ...
    private static final String TEST_NAME = "ItemSearchService"
    private static final String IO = "${TEST_NAME}_IO"
    private static final String PRODUCT_ITEM_CODE = 'Product'
    private static final String CATALOGVERSION_ITEM_CODE = 'CatalogVersion'
    private static final String CATALOG_ITEM_CODE = 'Catalog'
    private static final String TEST_CATALOG = "${TEST_NAME}_Catalog"
    private static final String ORIGINAL_CATALOG_VERSION = "Original"
    private static final String ANOTHER_CATALOG_VERSION = "Another"
    private static final String PRODUCT1_CODE = 'prod1'
    private static final String PRODUCT_1_DEFAULT = 'product1 default'
    private static final String PRODUCT_1_ANOTHER = 'product1 another catalog version'
