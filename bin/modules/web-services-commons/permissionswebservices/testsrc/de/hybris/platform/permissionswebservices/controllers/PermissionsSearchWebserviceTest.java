...
@IntegrationTest
public class PermissionsSearchWebserviceTest extends AbstractPermissionsWebServicesTest
{
	...
	public void shouldReturnAllTypesAccessesForAdmin() throws JAXBException
	{
		...
		final PermissionsListWsDTO entity = retrieveTypesPermissions(TESTADMIN_UID, TESTADMIN_UID, USER_ORDER_TYPECODES,
				TESTADMIN_PASSWORD);
	...
	{
		//when retrieving type permissions
		final PermissionsListWsDTO entity = retrieveTypesPermissions(USER1, TESTADMIN_UID, USER_ORDER_TYPECODES,
				TESTADMIN_PASSWORD);
	...
	public void shouldFailValidationForAttributes()
	{
		final Response result = wsSecuredRequestBuilder//
				...
				.post(Entity.json(Map.of("principalUid", "user2")));
	...
	{
		//given
		final WsRequestBuilder requestBuilder = new WsRequestBuilder()//
				.extensionName(PermissionswebservicesConstants.EXTENSIONNAME)//
				.path(VERSION);
		//when
			...
			final String attributes, final Locale language)
	{
		...
		final Response result = builder.build()//
				...
				.post(Entity.json(Map.of("principalUid", principal)));
			...
			final String password, final String fields)
	{
		WsSecuredRequestBuilder builder = wsSecuredRequestBuilder//
				...
				.queryParam("permissionNames", "read,change,create,remove,changerights")//
				.client("mobile_android", "secret").resourceOwner(user, password == null ? PASSWORD : password)//
				.grantResourceOwnerPasswordCredentials();
	...
	protected Response retrieveGlobalPermissionsResponse(final String principal, final String user, final String fields)
	{
		WsSecuredRequestBuilder builder = wsSecuredRequestBuilder//
				...
				.path("global")//
				.path("search")//
				.queryParam("permissionNames", "globalpermission1").resourceOwner(user, "1234").client("mobile_android", "secret")
				.grantResourceOwnerPasswordCredentials();
			...
			final String catalogIds, final String catalogVersions)
	{
		final WsSecuredRequestBuilder builder = wsSecuredRequestBuilder//
				...
				.client("mobile_android", "secret").resourceOwner(user, PASSWORD)//
				.grantResourceOwnerPasswordCredentials();
