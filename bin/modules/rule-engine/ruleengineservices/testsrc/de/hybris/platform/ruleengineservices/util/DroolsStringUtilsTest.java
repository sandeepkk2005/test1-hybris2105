...
public class DroolsStringUtilsTest
{
	...
	{
		for(final String s: testDataMap.get("VariableNameFail")) {
	...
	{
		for(final String s: testDataMap.get("FQCNFail")) {
			expectedException.expect(RuntimeException.class);
	...
	{
		for(final String s: testDataMap.get("SpringBeanNameFail")) {
			expectedException.expect(RuntimeException.class);
	...
	public void testValidateIndentationFailed()
	{
		...
		for(final String s: testDataMap.get("IndentationFail")) {
			expectedException.expect(RuntimeException.class);
