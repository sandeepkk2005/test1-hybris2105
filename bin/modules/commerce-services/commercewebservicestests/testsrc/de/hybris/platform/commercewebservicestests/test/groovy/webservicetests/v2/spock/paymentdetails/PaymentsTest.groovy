 ...
 */
package de.hybris.platform.commercewebservicestests.test.groovy.webservicetests.v2.spock.paymentdetails
...
class PaymentsTest extends AbstractUserTest {
	...
	def "Customer changes his default payment when request: #requestFormat and response: #responseFormat"() {
		...
		def info2 = createPaymentInfo(SECOND_PAYMENT_NON_DEFAULT_JSON, restClient, customer1, cart1.code, responseFormat)
