...
public class ChinesePaymentMockCheckoutFacade extends DefaultChineseCheckoutFacade implements ChineseCheckoutFacade
{
	...
	public String buildPaymentRequestUrl(final String orderCode)
	{
		...
		createTransactionForOrder(orderModel);
	...
	protected void createTransactionForOrder(final OrderModel orderModel)
	{
			...
			final PaymentTransactionModel transaction)
	{
		...
		entries.add(createTransactionEntry(orderModel, transaction, PaymentTransactionType.valueOf("REQUEST")));
