...
class SetupPackageRegistry {
    ...
    _writeInstructionBlock(message) {
        ...
        this._terminal.writeLine(Utilities_1.Utilities.wrapWords(message));
    ...
    async checkOnly() {
        var _a;
        const packageRegistry = this._artifactoryConfiguration.configuration
            .packageRegistry;
    ...
    async checkAndSetup() {
        ...
        if (this._messages.visitWebsite) {
            ...
            const artifactoryWebsiteUrl = this._artifactoryConfiguration.configuration.packageRegistry
