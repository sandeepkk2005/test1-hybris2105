...
public class ConfigurationBaseFacadeImpl
{
	...
	/**
	 * @deprecated use
	 *             {@link ConfigurationBaseFacadeImpl#getGroupsFromInstance(ConfigModel, InstanceModel, Map, List, int)}
	 *             instead
	 */
	...
	protected List<UiGroupData> getGroupsFromInstance(final InstanceModel instance,
			...
			final int level){
		return getGroupsFromInstance(null, instance, nameMap, csticGroupsFlat, level);
	}
	...
	/**
	 * @deprecated use {@link ConfigurationBaseFacadeImpl#createCsticGroup(ConfigModel, CsticGroup, InstanceModel, Map)}
	 *             instead
	 */
	@Deprecated(since = "2005", forRemoval = true)
	protected UiGroupData createCsticGroup(final CsticGroup csticModelGroup,
			final InstanceModel instance,
			final Map<String, ClassificationSystemCPQAttributesContainer> nameMap) {
		return createCsticGroup(null, csticModelGroup, instance, nameMap);
	}
	...
	/**
	 * @deprecated use {@link ConfigurationBaseFacadeImpl#createUiGroup(ConfigModel, InstanceModel, Map, List, int)}
	 *             instead
	 */
	@Deprecated(since = "2005", forRemoval = true)
	protected UiGroupData createUiGroup(final InstanceModel instance,
			final Map<String, ClassificationSystemCPQAttributesContainer> nameMap, final List<UiGroupData> csticGroupsFlat,
			final int level) {
		return createUiGroup(null, instance, nameMap, csticGroupsFlat, level);
	}
	/**
	...
	/**
	 * @deprecated use {@link ConfigurationBaseFacadeImpl#getListOfCsticData(ConfigModel, List, String, Map)} instead
	 */
	@Deprecated(since = "2005", forRemoval = true)
	protected List<CsticData> getListOfCsticData(final List<CsticModel> csticModelList, final String prefix,
			final Map<String, ClassificationSystemCPQAttributesContainer> nameMap)
	{
		return getListOfCsticData(null, csticModelList, prefix, nameMap);
	}
