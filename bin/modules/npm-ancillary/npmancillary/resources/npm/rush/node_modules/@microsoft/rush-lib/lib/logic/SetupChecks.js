...
class SetupChecks {
    static validate(rushConfiguration) {
        ...
        if (errorMessage) {
            console.error(safe_1.default.red(Utilities_1.Utilities.wrapWords(errorMessage)));
    ...
    static _checkForPhantomFolders(rushConfiguration) {
        ...
        if (phantomFolders.length > 0) {
            if (phantomFolders.length === 1) {
                console.log(safe_1.default.yellow(Utilities_1.Utilities.wrapWords('Warning: A phantom "node_modules" folder was found. This defeats Rush\'s protection against' +
                    ' NPM phantom dependencies and may cause confusing build errors. It is recommended to' +
                    ' delete this folder:')));
            }
            else {
                console.log(safe_1.default.yellow(Utilities_1.Utilities.wrapWords('Warning: Phantom "node_modules" folders were found. This defeats Rush\'s protection against' +
                    ' NPM phantom dependencies and may cause confusing build errors. It is recommended to' +
