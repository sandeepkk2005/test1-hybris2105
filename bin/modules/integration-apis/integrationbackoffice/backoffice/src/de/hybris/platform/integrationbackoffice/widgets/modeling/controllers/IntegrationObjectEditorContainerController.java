...
import static de.hybris.platform.integrationbackoffice.widgets.modeling.utility.EditorUtils.compileDuplicationMap;
...
public class IntegrationObjectEditorContainerController extends AbstractIntegrationEditorContainerController
{
	...
	@SocketEvent(socketId = "receiveObjectComboBox")
	...
	public void cloneIntegrationObject(final CreateIntegrationObjectModalData data)
	{
		...
		if (data.getComposedTypeModel() != null)
		{
			...
			final WriteService writeService = editorPresentation.getWriteService();
