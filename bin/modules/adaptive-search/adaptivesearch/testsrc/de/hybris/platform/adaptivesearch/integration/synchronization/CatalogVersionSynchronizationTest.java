...
public class CatalogVersionSynchronizationTest extends ServicelayerTest
{
	...
	{
		importCsv("/adaptivesearch/test/integration/synchronization/catalogVersionSynchronizationTest.impex",
	...
	@Test
	public void simpleSearchProfileNotFoundBeforeSynchronization() throws ImpExException
	{
		// given
		importCsv(
	...
	@Test
	public void synchronizeSimpleSearchProfile() throws ImpExException
	{
		// given
		importCsv(
				"/adaptivesearch/test/integration/synchronization/catalogVersionSynchronizationTest_create_simpleSearchProfile.impex",
		...
		// then
		assertTrue(stagedSearchProfile.orElseThrow() instanceof AsSimpleSearchProfileModel);
		assertTrue(onlineSearchProfile.orElseThrow() instanceof AsSimpleSearchProfileModel);
		assertEqualsSimpleSearchProfile((AsSimpleSearchProfileModel) stagedSearchProfile.orElseThrow(),
				(AsSimpleSearchProfileModel) onlineSearchProfile.orElseThrow());
		assertEqualsSearchProfileActivationSet(stagedActivationSet, onlineActivationSet);
	}

	@Test
	public void synchronizeSimpleSearchProfileAfterUpdate1() throws ImpExException
	{
		// given
		importCsv(
				"/adaptivesearch/test/integration/synchronization/catalogVersionSynchronizationTest_create_simpleSearchProfile.impex",
	...
	@Test
	public void synchronizeSimpleSearchProfileAfterUpdate2() throws ImpExException
	{
		// given
		importCsv(
				"/adaptivesearch/test/integration/synchronization/catalogVersionSynchronizationTest_create_simpleSearchProfile.impex",
	...
	@Test
	public void catAwareSearchProfileNotFoundBeforeSynchronization() throws ImpExException
	{
		// given
		importCsv(
	...
	@Test
	public void synchronizeCatAwareSearchProfile() throws ImpExException
	{
		// given
		importCsv(
				"/adaptivesearch/test/integration/synchronization/catalogVersionSynchronizationTest_create_catAwareSearchProfile.impex",
		...
		// then
		assertTrue(stagedSearchProfile.orElseThrow() instanceof AsCategoryAwareSearchProfileModel);
		assertTrue(onlineSearchProfile.orElseThrow() instanceof AsCategoryAwareSearchProfileModel);
		assertEqualsCatAwareSearchProfile((AsCategoryAwareSearchProfileModel) stagedSearchProfile.orElseThrow(),
				(AsCategoryAwareSearchProfileModel) onlineSearchProfile.orElseThrow());
		assertEqualsSearchProfileActivationSet(stagedActivationSet, onlineActivationSet);
	}

	@Test
	public void synchronizeCatAwareSearchProfileAfterUpdate1() throws ImpExException
	{
		// given
		importCsv(
				"/adaptivesearch/test/integration/synchronization/catalogVersionSynchronizationTest_create_catAwareSearchProfile.impex",
	...
	@Test
	public void synchronizeCatAwareSearchProfileAfterUpdate2() throws ImpExException
	{
		// given
		importCsv(
				"/adaptivesearch/test/integration/synchronization/catalogVersionSynchronizationTest_create_catAwareSearchProfile.impex",
			...
			final Optional<AsSearchProfileActivationSetModel> activationSetResult2)
	{
		...
		final AsSearchProfileActivationSetModel activationSet1 = activationSetResult1.orElseThrow();
		final AsSearchProfileActivationSetModel activationSet2 = activationSetResult2.orElseThrow();
