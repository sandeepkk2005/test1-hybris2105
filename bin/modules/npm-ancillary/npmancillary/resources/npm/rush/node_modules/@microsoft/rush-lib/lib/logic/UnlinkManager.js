...
class UnlinkManager {
    ...
    _deleteProjectFiles() {
        ...
        for (const rushProject of this._rushConfiguration.projects) {
            ...
            const projectDependencyManifestFilePath = PnpmProjectDependencyManifest_1.PnpmProjectDependencyManifest.getFilePathForProject(rushProject);
            if (node_core_library_1.FileSystem.exists(projectDependencyManifestFilePath)) {
                console.log(`Deleting ${projectDependencyManifestFilePath}`);
                node_core_library_1.FileSystem.deleteFile(projectDependencyManifestFilePath);
                didDeleteAnything = true;
            }
        }
