...
public class FindBundlePricingWithCurrentPriceFactoryStrategy extends FindSubscriptionPricingWithCurrentPriceFactoryStrategy
{
	...
	private transient SubscriptionCommercePriceService subscriptionCommercePriceService;
	
	private transient BundleTemplateService bundleTemplateService;

	/**
	 * For non Bundle products it should work as is, so the DiscountValues should result
