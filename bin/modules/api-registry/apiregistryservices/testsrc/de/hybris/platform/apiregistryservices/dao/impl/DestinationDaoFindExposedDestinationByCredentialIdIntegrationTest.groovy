...
class DestinationDaoFindExposedDestinationByCredentialIdIntegrationTest extends ServicelayerTransactionalSpockSpecification
{
	@Resource
	...
	def "find #expectResult #description #credentialId"()
	{
		...
		expect:
		destinationDao.findExposedDestinationsByCredentialId(credentialId).size() == expectResult;
