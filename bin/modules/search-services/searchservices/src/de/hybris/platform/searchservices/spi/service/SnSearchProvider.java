...
public interface SnSearchProvider<T extends AbstractSnSearchProviderConfiguration>
{
	 ...
	 *            if an error occurs
	 *
	 * @deprecated Replaced by {@link #getSearchProviderConfiguration(SnIndexConfiguration)}.
	 */
	 ...
	 *            if an error occurs
	 *
	 * @deprecated Replaced by {@link #exportConfiguration(SnExportConfiguration, List)}.
	 */
	@Deprecated(since = "2105", forRemoval = true)
	 ...
	 *            if an error occurs
	 *
	 * @deprecated This is no longer supported, replaced by {@link #createIndex(SnContext)}.
	 */
	@Deprecated(since = "2105", forRemoval = true)
