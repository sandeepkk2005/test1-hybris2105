...
export declare class PnpmShrinkwrapFile extends BaseShrinkwrapFile {
     ...
     * @override
     */
    protected tryEnsureDependencyVersion(dependencySpecifier: DependencySpecifier, tempProjectName: string, tryReusingPackageVersionsFromShrinkwrap: boolean): DependencySpecifier | undefined;
    /** @override */
    getWorkspaceKeys(): ReadonlyArray<string>;
    /** @override */
    getWorkspaceKeyByPath(workspaceRoot: string, projectFolder: string): string;
    getWorkspaceImporter(importerPath: string): IPnpmShrinkwrapImporterYaml | undefined;
    /**
     * Gets the resolved version number of a dependency for a specific temp project.
     * For PNPM, we can reuse the version that another project is using.
     ...
     * @override
     */
    protected getWorkspaceDependencyVersion(dependencySpecifier: DependencySpecifier, workspaceKey: string): DependencySpecifier | undefined;
    /**
