...
public class IntegrationbackofficetestManager extends GeneratedIntegrationbackofficetestManager
{
	 ...
	 */
	public static IntegrationbackofficetestManager getInstance()
	{
		return (IntegrationbackofficetestManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
		                                                  .getExtension(IntegrationbackofficetestConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public IntegrationbackofficetestManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of IntegrationbackofficetestManager called.");
		}
	}
