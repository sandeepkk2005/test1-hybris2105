...
@UnitTest
public class FacetCountComparatorTest
{

	private final FacetCountComparator facetCountComparator = new FacetCountComparator();
	...
	public void bothFacetValuesNull() throws Exception
	{
		...
		final int result = facetCountComparator.compare(value1, value2);
	...
	@Test
	public void firstFacetCountLessThanSecondFacetCount() throws Exception
	{
		final FacetValue value1 = new FacetValue("name1", 1, true);
		final FacetValue value2 = new FacetValue("name2", 2, true);
