...
public class DefaultDataHubConfigServiceTest extends ServicelayerTransactionalBaseTest
{
	...
	public void shouldGenerateDataHubModelForStreamConfigurationContainer() throws Exception
	{
		...
		//rename streams to make sure the configs are processed in given order
		//normally the order is not important, but this test is comparing the result xml with a given one and the order must be deterministic
