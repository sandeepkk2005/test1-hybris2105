...
@UnitTest
public class AsBoostItemsReplaceMergeStrategyTest extends AbstractAsBoostItemsMergeStrategyTest
{
	...
	public void mergePromotedItems()
	{
		...
		// then
		assertEquals(AsBoostItemsMergeMode.REPLACE, getTarget().getBoostItemsMergeMode());
