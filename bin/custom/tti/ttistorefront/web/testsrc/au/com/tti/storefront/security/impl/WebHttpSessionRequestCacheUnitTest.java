...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ttistorefront/electronics/en",
						"https://electronics.local:9002/ttistorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ttistorefront/electronics/en",
						"https://electronics.local:9002/ttistorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ttistorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ttistorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ttistorefront/electronics/en",
						"https://electronics.local:9002/ttistorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ttistorefront",
						"https://electronics.local:9002/ttistorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ttistorefront",
						"https://electronics.local:9002/ttistorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ttistorefront/electronics/en",
						"https://electronics.local:9002/ttistorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
