...
import {PersonalizationsmarteditCombinedViewConfigureControllerScope} from 'personalizationsmarteditcontainer/combinedView/PersonalizationsmarteditCombinedViewConfigureController'
...
describe('Test Personalizationsmartedit Combined View Module', () => {
	...
	let $scope: jasmine.SpyObj<PersonalizationsmarteditCombinedViewConfigureControllerScope>;
	...
	it('GIVEN that personalizationsmarteditCombinedViewConfigureController properties in scope are instantiated properly', () => {
		...
		//TODO: private $scope, use any to fix temporarily
		expect((personalizationsmarteditCombinedViewConfigureController as any).$scope.selectedItems).toBeDefined();
		expect((personalizationsmarteditCombinedViewConfigureController as any).$scope.selectedElement).toBeDefined();
		expect((personalizationsmarteditCombinedViewConfigureController as any).$scope.selectionArray).toBeDefined();
