...
export class RestrictionsEditorComponent implements OnInit, OnDestroy, OnChanges {
    ...
    /**
     * Function that returns an array of supported restriction types. The invoker can bind this to a custom function to fetch these values and perform other operations. If not provide, all types are assumed to be supported.
     */
    ...
    constructor(
        ...
        private restrictionPickerConfigService: RestrictionPickerConfigService,
    ...
    async ngOnInit(): Promise<void> {
        ...
        this.isDirtyFnChange.emit(
            () =>
                ...
                (this.matchCriteriaIsDirty && this.restrictionUuids.length >= 2)
        );
