 ...
 */
package au.com.tti.core.constants;

/**
 * Global class for all TtiCore constants. You can add global constants for your extension into this class.
 */
public final class TtiCoreConstants extends GeneratedTtiCoreConstants
{
	public static final String EXTENSIONNAME = "tticore";


	private TtiCoreConstants()
	{
		//empty
	}
