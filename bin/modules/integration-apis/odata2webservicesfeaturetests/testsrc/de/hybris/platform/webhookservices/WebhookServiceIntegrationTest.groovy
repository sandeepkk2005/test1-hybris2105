...
class WebhookServiceIntegrationTest extends ServicelayerSpockSpecification {
    ...
    @Shared
    @ClassRule
    IntegrationObjectModelBuilder ioBuilder = IntegrationObjectModelBuilder.integrationObject()
            .withCode(EXISTING_IO_CODE)
            .withItem(integrationObjectItem().withCode('Catalog').root())
    @Rule
    ConsumedDestinationBuilder existingDestination = ConsumedDestinationBuilder.consumedDestinationBuilder()
