...
public class SolrSynonymsIntegrationTest extends AbstractIntegrationTest
{
	...
	@Test
	public void testUpdateSynonymsTwoTimesWithCaseSensitiveSynonymKeys()
			throws FacetConfigServiceException, FacetSearchException, ImpExException, IOException, IndexerException
	{
		//given
		importConfig("/test/integration/DefaultSolrSynonymServiceIntegrationTest_updateSynonyms_caseInsensitiveSynonymKey.csv");
		//1st full index -> create synonyms
		indexerService.performFullIndex(getFacetSearchConfig());
		//2dn full index -> delete and update synonyms on server
		indexerService.performFullIndex(getFacetSearchConfig());
	...
	@Test
	public void testDeleteSynonymsWithSpecialCharacterKeys()
			throws FacetConfigServiceException, FacetSearchException, ImpExException, IOException, IndexerException
	{
		//given
		//add synonyms with special characters and index
		importConfig("/test/integration/DefaultSolrSynonymServiceIntegrationTest_addSynonyms_specialChars.csv");
		indexerService.performFullIndex(getFacetSearchConfig());
		//remove synonyms and reindex
		importConfig("/test/integration/DefaultSolrSynonymServiceIntegrationTest_deleteSynonyms_specialChars.csv");
		indexerService.performFullIndex(getFacetSearchConfig());
