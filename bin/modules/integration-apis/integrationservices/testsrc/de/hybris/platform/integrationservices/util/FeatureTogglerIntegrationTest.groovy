...
@IntegrationTest
class FeatureTogglerIntegrationTest extends ServicelayerSpockSpecification {
    ...
    def "isFeatureEnabled is #value"() {
        ...
        expect:
        FeatureToggler.isFeatureEnabled(TestFeature.FEATURE_TEST_EXISTING) == value
    ...
    def "isFeatureEnabled returns false when feature is #feature"() {
        expect:
        !FeatureToggler.isFeatureEnabled(feature)
