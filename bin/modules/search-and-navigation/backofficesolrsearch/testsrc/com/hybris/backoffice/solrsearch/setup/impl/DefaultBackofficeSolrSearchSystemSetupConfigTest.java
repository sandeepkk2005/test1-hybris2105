...
public class DefaultBackofficeSolrSearchSystemSetupConfigTest
{
	...
	private void mockConfigResolverWithNonEmptyKeys()
	{
		...
		when(configStringResolver.resolveConfigStringParameter(BACKOFFICE_SOLR_SEARCH_LOCALIZED_ROOTS_KEY))
	...
	{
		when(configStringResolver.resolveConfigStringParameter(BACKOFFICE_SOLR_SEARCH_NON_LOCALIZED_ROOTS_KEY))
				.thenReturn(CONFIGURED_FILE_LIST);
	}
}
