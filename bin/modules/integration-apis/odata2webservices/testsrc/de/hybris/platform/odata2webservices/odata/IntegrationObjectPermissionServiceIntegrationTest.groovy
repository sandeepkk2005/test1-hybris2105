...
class IntegrationObjectPermissionServiceIntegrationTest extends ServicelayerSpockSpecification {
    private static final String IO = 'IntegrationObjectPermissionService_IO'
    ...
    IntegrationObjectModelBuilder integrationObject = integrationObject().withCode(IO)
            ...
            .withItem(integrationObjectItem().withCode('PriceRow').root()
                    .withAttribute(integrationObjectItemAttribute('currency').unique().withReturnItem('Currency'))
                    .withAttribute(integrationObjectItemAttribute('price').unique())
                    .withAttribute(integrationObjectItemAttribute('unit').withReturnItem('Unit').autoCreate())
                    .withAttribute(integrationObjectItemAttribute('matchValue')))
