...
public class DataHubRequestCreatorValidURLIntegrationTest extends ServicelayerBaseTest
{
	...
	public void shouldGenerateValidMediaULRsForY2YSyncDataStreams() throws Exception
	{
		...
		assertThat(argumentCaptor.getValue().getDataStreams()).flatExtracting(DataStream::getUrls)
		                                                      .allMatch(urlValidator::isValid);
	...
	private ProcessChangesTask givenProcessChangesTaskWith(final ImportScript... scripts)
	{
		final Map<String, Object> context = ImmutableMap.<String, Object>builder()
				...
				.put(SyncTaskFactory.SYNC_EXECUTION_ID_KEY, SYNC_EXECUTION_ID)
				.put(SyncTaskFactory.SYNC_TYPE_KEY, Y2YSyncType.DATAHUB)
				.put(SyncTaskFactory.MEDIA_PK_KEY, PK.createFixedUUIDPK(1, 1))
				.build();
