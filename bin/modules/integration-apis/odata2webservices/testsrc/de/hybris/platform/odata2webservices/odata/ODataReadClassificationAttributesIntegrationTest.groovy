...
@IntegrationTest
class ODataReadClassificationAttributesIntegrationTest extends ServicelayerSpockSpecification {
    private static final def TEST_NAME = 'ODataReadClassificationAttributes'
    ...
    private static final def BIKE_IO = "${TEST_NAME}_BikeIO"
    private static final def CATALOG = "Default"
    private static final def VERSION = 'Staged'
    private static final def CATALOG_VERSION = CATALOG.concat(":").concat(VERSION)
    private static final def PRODUCT1 = CATALOG_VERSION.concat(":prod1")
    private static final def PRODUCT2 = CATALOG_VERSION.concat(":prod2")
    private static final def PRODUCT3 = CATALOG_VERSION.concat(":prod3")
