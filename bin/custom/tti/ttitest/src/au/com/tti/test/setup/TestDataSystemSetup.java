...
import au.com.tti.test.constants.TtiTestConstants;
import au.com.tti.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TtiTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ttitest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ttitest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/ttitest/import/cstickets.impex");
			...
			importImpexFile(context, "/ttitest/import/csquotes.impex");
		}
	}
}
