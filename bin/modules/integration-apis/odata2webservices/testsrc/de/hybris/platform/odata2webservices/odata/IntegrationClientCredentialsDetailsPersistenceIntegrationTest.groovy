...
class IntegrationClientCredentialsDetailsPersistenceIntegrationTest extends ServicelayerSpockSpecification {
    private static final String TEST_NAME = 'IntegrationClientCredentialsDetailsPersistence'
    private static final String CLIENT_ID = "${TEST_NAME}_Cred1"
    private static final String EXISTING_USER_UID = "${TEST_NAME}_Kaitlin"
    ...
    def "cannot update an existing IntegrationClientCredentialsDetails user"() {
        ...
        def userUid2 = "${TEST_NAME}_someOtherUser"
