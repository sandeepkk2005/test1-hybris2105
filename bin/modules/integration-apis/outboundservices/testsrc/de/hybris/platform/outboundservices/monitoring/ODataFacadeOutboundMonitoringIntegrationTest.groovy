...
class ODataFacadeOutboundMonitoringIntegrationTest extends ServicelayerBaseSpecification {
    ...
    private static SyncParameters syncParameters(final OutboundSource source = OutboundSource.OUTBOUNDSYNC, final EventType operation = new DefaultEventType('Created')) {
