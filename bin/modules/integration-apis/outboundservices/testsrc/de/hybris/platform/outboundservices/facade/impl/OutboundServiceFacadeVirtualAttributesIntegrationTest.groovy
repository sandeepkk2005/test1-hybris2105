...
class OutboundServiceFacadeVirtualAttributesIntegrationTest extends ServicelayerSpockSpecification {
    private static final String TEST_NAME = "OutboundServiceFacadeVirtualAttributes"
    private static final String IO = "${TEST_NAME}_IO"
    private static final String UNIT_IOI_CODE = 'UnitItem'
    private static final String SCRIPT_CODE = "${TEST_NAME}_Script"
    private static final String SCRIPT_LOCATION = "model://$SCRIPT_CODE"
    private static final String DESCRIPTOR_CODE = "${TEST_NAME}_Descriptor"
    ...
    private static final String UNIT_CODE = "${TEST_NAME}_pieces"
