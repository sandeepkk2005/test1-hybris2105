...
class ODataExpandEntityIntegrationTest extends ServicelayerSpockSpecification {
    ...
    private static final String TEST_IO = TEST_NAME.concat('_ExpandTest_IO');
    private static final String TEST_IO_MAP = TEST_NAME.concat('_ExpandTest_Map')
    private static final def CATALOG = TEST_NAME.concat('_Catalog')
    private static final def VERSION = TEST_NAME.concat('_TestVersion')
