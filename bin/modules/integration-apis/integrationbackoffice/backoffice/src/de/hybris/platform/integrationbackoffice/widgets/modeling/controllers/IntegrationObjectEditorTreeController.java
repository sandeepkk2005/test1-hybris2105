...
import static de.hybris.platform.integrationbackoffice.widgets.modeling.utility.EditorTrimmer.trimMap;
import static de.hybris.platform.integrationbackoffice.widgets.modeling.utility.EditorUtils.convertIntegrationObjectToDTOMap;
...
import static de.hybris.platform.integrationbackoffice.widgets.modeling.utility.EditorUtils.getReferenceClassificationAttributes;
import static de.hybris.platform.integrationbackoffice.widgets.modeling.utility.EditorUtils.getStructuredAttributes;
...
import de.hybris.platform.integrationbackoffice.widgets.modeling.builders.TreeBuilder;
		...
		treeNodeDataSet.stream()
		               ...
		               .forEach(treeNodeData -> {
					               ...
					               && !EditorBlacklists.getTypesBlackList().contains(composedType.getCode()))
			               {
				               ...
				               {
					               editorPresentation.setCurrentAttributesMap(
					               		editorPresentation.getDataStructureBuilder().populateAttributesMap(composedType,
