...
@IntegrationTest
class ODataPrimitiveCollectionPersistenceFacadeIntegrationTest extends ServicelayerSpockSpecification {

    def TEST_NAME = 'ODataPrimitiveCollectionPersistenceFacade'
    def SERVICE_NAME = "${TEST_NAME}_PrimitiveCollectionIO"
    def CATALOG = TEST_NAME.concat("_Default")
    def PRODUCT = TEST_NAME.concat("_prod1")
	...
	def "can persist and get an Integer collection"() {
		...
		IntegrationTestUtil.importImpEx(
				...
				"; ${TEST_NAME}_prod1 ; \$catalogVersion ; product1",
	...
	def integrationObjectWithIntegerCollection() {
		JsonBuilder.json()
				...
				.withField("product", JsonBuilder.json().withCode(PRODUCT)
