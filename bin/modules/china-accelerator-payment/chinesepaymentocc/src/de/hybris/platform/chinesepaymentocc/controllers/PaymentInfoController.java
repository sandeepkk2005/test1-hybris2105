 ...
 */
package de.hybris.platform.chinesepaymentocc.controllers;
...
import de.hybris.platform.chinesepaymentocc.exceptions.CartVoucherExpiredException;
...
public class PaymentInfoController
{
	...
	/**
	 * @deprecated (deprecated since 2105, the exception message is composed in exception class)
	 */
	@Deprecated(since = "2105", forRemoval = true)
