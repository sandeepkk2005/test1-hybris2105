...
describe('PersonalizationsmarteditToolbarContextModule', () => {
	...
	beforeEach(angular.mock.inject((_$rootScope_: angular.IRootScopeService) => {
		...
		personalizationsmarteditPreviewService = jasmine.createSpyObj('personalizationsmarteditPreviewService', ['updatePreviewTicketWithVariations','removePersonalizationDataFromPreview']);
