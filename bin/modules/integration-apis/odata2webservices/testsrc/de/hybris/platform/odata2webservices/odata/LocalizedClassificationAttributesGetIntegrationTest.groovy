...
@IntegrationTest
class LocalizedClassificationAttributesGetIntegrationTest extends ServicelayerSpockSpecification {
    private static final String TEST_NAME = "LocalizedClassificationAttributesGet"
    ...
    private static final String PRODUCT_CODE_ENCODED = "${TEST_NAME}_prod1"
    ...
    def setup() {
        ...
        IntegrationTestUtil.importImpEx(
                ...
                "                     ; ${PRODUCT_CODE_ENCODED} ; $CLASS_SYSTEM_VERSION",
    ...
    def "Expands nested classification localizedAttributes"() {
        ...
        IntegrationTestUtil.importImpEx(
                ...
                "                        ; theOrder                      ; 1                         ; ${PRODUCT_CODE_ENCODED}; $unit     ; 1")
