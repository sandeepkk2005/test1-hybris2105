...
class InboundChannelConfigurationPersistenceIntegrationTest extends ServicelayerSpockSpecification {
    ...
    private static final String EXISTING_IO = "InboundChannelConfigurationPersistence_IO"
    ...
    def cleanupSpec() {
        IntegrationTestUtil.remove(IntegrationObjectModel) {it.code == EXISTING_IO }
    }
