...
class ScriptServiceSecurityIntegrationTest extends ServicelayerSpockSpecification {
    ...
    private static final String TEST_NAME = "ScriptServiceSecurity"
    private static final String SCRIPT_CODE = "${TEST_NAME}_MyScript"
    ...
    private static final def users = [ADMIN_USER, SCRIPT_SERVICE_USER, MONITOR_USER, SERVICE_USER, CREATE_USER, VIEW_USER, DELETE_USER, ADMIN_MONITOR_USER, ADMIN_SERVICE_USER,
    ...
    private static final String SCRIPT_PAYLOAD = "{\"code\": \"${SCRIPT_CODE}\", \"scriptType\": {\"code\":\"GROOVY\"}, \"content\": \"helloWorld\"}"
    ...
    def "#user gets Not Found when sending a PATCH to /ScriptService/#feed"() {
        ...
        where:
        feed                      | user                    | jsonBody
        "Scripts('$SCRIPT_CODE')" | ADMIN_OUTBOUNDSYNC_USER | SCRIPT_PAYLOAD
        "Scripts('$SCRIPT_CODE')" | ADMIN_SERVICE_USER      | SCRIPT_PAYLOAD
        "Scripts('$SCRIPT_CODE')" | ADMIN_MONITOR_USER      | SCRIPT_PAYLOAD
    }
    ...
    def "#user gets #responseStatus when DELETE /ScriptService/#feed"() {
        ...
        "Scripts('$SCRIPT_CODE')" | ADMIN_OUTBOUNDSYNC_USER   | HttpStatusCodes.NOT_FOUND
        "Scripts('$SCRIPT_CODE')" | ADMIN_MONITOR_USER        | HttpStatusCodes.NOT_FOUND
        "Scripts('$SCRIPT_CODE')" | ADMIN_SERVICE_USER        | HttpStatusCodes.NOT_FOUND
        "Scripts('$SCRIPT_CODE')" | ADMIN_SCRIPT_SERVICE_USER | HttpStatusCodes.OK
    }
