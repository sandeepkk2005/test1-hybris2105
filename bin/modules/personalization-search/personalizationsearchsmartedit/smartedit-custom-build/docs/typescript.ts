...
<em>personalizationsearchsmartedit/web/features/personalizationsearchsmarteditContainer/personalizationsearchsmarteditcontainermodule.ts</em>
```ts
...
export class PersonalizationsearchsmarteditContainer {}
```
...
SmartEdit uses Webpack, a module bundler, to bundle the application. The TypeScript source code is transpiled into JavaScript and the existing JavaScript code (ES5) is bundled as is. The following files are the Webpack configuration for the personalizationsearchsmartedit:
- <em>personalizationsearchsmartedit/smartedit-custom-build/generated/webpack.[dev/prod/karma].smartedit.config.js</em>
- <em>personalizationsearchsmartedit/smartedit-custom-build/generated/webpack.[dev/prod/karma].smarteditContainer.config</em>

The 'personalizationsearchsmartedit' layer of personalizationsearchsmartedit is a bundle of personalizationsearchsmartedit.
The 'personalizationsearchsmarteditContainer' layer of personalizationsearchsmartedit is a bundle of personalizationsearchsmarteditContainer.
