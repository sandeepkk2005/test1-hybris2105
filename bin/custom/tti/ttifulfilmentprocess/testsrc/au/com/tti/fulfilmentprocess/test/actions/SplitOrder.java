 ...
 */
package au.com.tti.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TtiFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TtiFulfilmentProcessConstants.PARENT_PROCESS);
