...
public class DefaultRaoService
{
	...
	public OrderEntryRAO createOrderEntry(final AbstractOrderRAO order, final String product, final double basePrice,
	...
	public void addPromotedProduct(final String productCode, final int quantity, final double basePrice, final double value,
			final CartRAO cart)
	{
		final OrderEntryRAO discountedEntry = addProduct(productCode, quantity, basePrice, cart);
		addEntryDiscount(true, value, discountedEntry);
	}

	public OrderEntryRAO addProduct(final String promotedProduct, final int quantity, final double basePrice,
			final CartRAO cart)
	{
