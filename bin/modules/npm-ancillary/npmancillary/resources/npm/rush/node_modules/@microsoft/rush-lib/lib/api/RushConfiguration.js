...
class RushConfiguration {
    ...
    constructor(rushConfigurationJson, rushJsonFilename) {
        ...
        RushConfiguration._validateCommonRushConfigFolder(this._commonRushConfigFolder, this.packageManager, this._shrinkwrapFilename, this._experimentsConfiguration);
     ...
     */
    static _validateCommonRushConfigFolder(commonRushConfigFolder, packageManager, shrinkwrapFilename, experiments) {
        ...
        for (const filename of node_core_library_1.FileSystem.readFolder(commonRushConfigFolder)) {
            ...
            if (experiments.configuration.buildCache) {
                knownSet.add(RushConstants_1.RushConstants.buildCacheFilename.toUpperCase());
            }
