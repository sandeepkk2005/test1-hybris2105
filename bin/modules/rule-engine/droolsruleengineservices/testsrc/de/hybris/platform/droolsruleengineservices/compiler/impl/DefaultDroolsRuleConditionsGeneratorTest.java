...
public class DefaultDroolsRuleConditionsGeneratorTest extends AbstractGeneratorTest
{
	...
	public void setUp()
	{
		...
		when(configuration.getBoolean("droolsruleengineservices.generate.unique.fact.matching.condition", true)).thenReturn(true);
	...
	public void testSingleNotCondition() throws IOException
	{
		...
		when(droolsRuleValueFormatter.formatValue(any(), eq(entry)))
				.thenReturn("\"1234567\"");
		// when
	...
	public void testSingleCondition() throws IOException
	{
		...
		when(droolsRuleValueFormatter.formatValue(any(), eq(amountCondition))).thenReturn(
	...
	public void testSingleRelConditionWithTargetAttribute() throws IOException
	{
		...
		when(droolsRuleValueFormatter.formatValue(any(), eq(qtyCondition))).thenReturn("new Integer(1)");
	...
	public void testMultipleConditions() throws IOException
	{
		...
		when(droolsRuleValueFormatter.formatValue(any(), eq(colorCondition))).thenReturn("\"blue\"");
		when(droolsRuleValueFormatter.formatValue(any(), eq(amountCondition))).thenReturn(
				"new java.math.BigDecimal(\"100\")");
		when(droolsRuleValueFormatter.formatValue(any(), eq(code)))
	...
	public void testMultipleConditionsWithSameTypeVariables() throws IOException
	{
		...
		when(droolsRuleValueFormatter.formatValue(any(), eq(colorCondition))).thenReturn("\"blue\"");
		when(droolsRuleValueFormatter.formatValue(any(), eq(colorConditionForProduct2))).thenReturn("\"red\"");
		when(droolsRuleValueFormatter.formatValue(any(), eq(amountCondition))).thenReturn(
				"new java.math.BigDecimal(\"100\")");
		when(droolsRuleValueFormatter.formatValue(any(), eq(code)))
				.thenReturn("productCode == \"123\" || productCode == \"456\" || productCode == \"789\"");
	...
	public void testDisableUniqueFactMatchingCondition() throws IOException
	{
		...
		when(droolsRuleValueFormatter.formatValue(any(), eq(colorCondition))).thenReturn("\"blue\"");
		when(droolsRuleValueFormatter.formatValue(any(), eq(colorConditionForProduct2))).thenReturn("\"red\"");
		when(droolsRuleValueFormatter.formatValue(any(), eq(amountCondition))).thenReturn("new java.math.BigDecimal(\"100\")");
		when(droolsRuleValueFormatter.formatValue(any(), eq(code)))
				.thenReturn("productCode == \"123\" || productCode == \"456\" || productCode == \"789\"");

		when(configuration.getBoolean("droolsruleengineservices.generate.unique.fact.matching.condition", true)).thenReturn(false);
		// when
		final String generatedDroolsCode = conditionsGenerator.generateConditions(droolsRuleGeneratorContext, INDENTATION);
	...
	protected List<RuleIrCondition> createPatternConditions()
	{
		...
		when(droolsRuleValueFormatter.formatValue(any(), eq(attributeCondition)))
	...
	private List<RuleIrCondition> createGroupConditions()
	{
		...
		when(droolsRuleValueFormatter.formatValue(any(), eq(attributeCondition111)))
				.thenReturn("\"1234567\"");
		when(droolsRuleValueFormatter.formatValue(any(), eq(attributeCondition211)))
				.thenReturn("\"902\"");
		when(droolsRuleValueFormatter.formatValue(any(), eq(attributeCondition113)))
				.thenReturn("new Integer(1)");
		when(droolsRuleValueFormatter.formatValue(any(), eq(attributeCondition213)))
				.thenReturn("new Integer(1)");
	...
	private List<RuleIrCondition> createGroupNotConditions()
	{
		...
		when(droolsRuleValueFormatter.formatValue(any(), eq(attributeCondition111)))
				.thenReturn("\"USD\"");
		when(droolsRuleValueFormatter.formatValue(any(), eq(attributeCondition112)))
				.thenReturn("new BigDecimal(\"100\")");
		when(droolsRuleValueFormatter.formatValue(any(), eq(attributeCondition121)))
