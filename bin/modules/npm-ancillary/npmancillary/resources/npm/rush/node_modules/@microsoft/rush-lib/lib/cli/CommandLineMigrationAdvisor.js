...
class CommandLineMigrationAdvisor {
    ...
    static _reportDeprecated(message) {
        console.error(safe_1.default.red(Utilities_1.Utilities.wrapWords('ERROR: You specified an outdated command-line that is no longer supported by this version of Rush:')));
        console.error(safe_1.default.yellow(Utilities_1.Utilities.wrapWords(message)));
        console.error();
        console.error(Utilities_1.Utilities.wrapWords(`For command-line help, type "rush -h".  For migration instructions,` +
