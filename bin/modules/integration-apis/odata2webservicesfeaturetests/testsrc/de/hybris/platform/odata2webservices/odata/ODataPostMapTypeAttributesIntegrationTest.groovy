...
class ODataPostMapTypeAttributesIntegrationTest extends ServicelayerSpockSpecification {
    ...
    private static final String TEST_NAME = "ODataPostMapTypeAttributes"
    ...
    private static final def PRODUCT_CODE = "product"
    private static final def TEST_ITEM_CODE = "${TEST_NAME}_Code"
