...
class OutboundChannelConfigSecurityIntegrationTest extends ServicelayerSpockSpecification {
    ...
    def "#user gets #status when sending a DELETE to /OutboundChannelConfig/#existingItem"() {
        ...
        "ConsumedDestinations('$DESTINATION_ID|$DEST_TARGET_ID')"    | ADMIN_OUTBOUNDSYNC_USER    | HttpStatusCodes.BAD_REQUEST
        "DestinationTargets('$DEST_TARGET_ID')"                      | ADMIN_OUTBOUNDSYNC_USER    | HttpStatusCodes.OK
        "Endpoints('$ENDPOINT_ID|$ENDPOINT_VERSION')"                | ADMIN_OUTBOUNDSYNC_USER    | HttpStatusCodes.BAD_REQUEST
        ...
        "IntegrationObjects('$IOBJECT_CODE')"                        | ADMIN_OUTBOUNDSYNC_USER    | HttpStatusCodes.BAD_REQUEST
