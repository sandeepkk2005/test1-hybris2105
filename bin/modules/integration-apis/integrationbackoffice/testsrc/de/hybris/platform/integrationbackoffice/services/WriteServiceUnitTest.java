...
public class WriteServiceUnitTest
{
	...
	public void setUp()
	{
		...
		when(modelService.create(IntegrationObjectItemVirtualAttributeModel.class)).thenReturn(
	...
	public void testCloneIntegrationObjectItemAttribute()
	{
		...
		itemsCloneMap.put(clonedCatalogIntegrationObjectItem.getType().getCode(), clonedCatalogIntegrationObjectItem);
