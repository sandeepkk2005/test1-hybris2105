...
public class ItemTypeGroupingCollectorWithBatchingTest
{
	...
	public void shouldGroupChangesByItemType()
	{
		...
		final ItemTypeGroupingCollectorWithBatching itemTypeGroupingCollectorWithBatching = new ItemTypeGroupingCollectorWithBatching(
				new TestCollectorFactory(collectorsPool));
