...
import de.hybris.platform.integrationbackoffice.widgets.modeling.utility.EditorTrimmer;
...
public class EditorTrimmerUnitTest
{
	...
	public void setUp()
	{
		...
		integrationObjectPresentation = new IntegrationObjectPresentation(null, readService, null, null);
