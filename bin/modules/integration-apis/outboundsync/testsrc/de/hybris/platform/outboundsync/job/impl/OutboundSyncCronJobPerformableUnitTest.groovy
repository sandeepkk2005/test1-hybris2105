...
class OutboundSyncCronJobPerformableUnitTest extends Specification {
    ...
    def "perform does not process excluded types configured in the stream configuration"() {
        ...
        then:
        1 * changeDetectionService.collectChangesForType(_ as ComposedTypeModel, _ as StreamConfiguration, collector1) >> { args ->
    ...
    def composedTypeModel(String type) {
    ...
    def streamConfiguration(def streamId, def typeCode, Set excludedTypes) {
