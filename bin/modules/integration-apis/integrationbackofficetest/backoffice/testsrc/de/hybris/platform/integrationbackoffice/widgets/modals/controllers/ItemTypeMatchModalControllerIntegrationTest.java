...
{
	private static final String TEST_NAME = "ItemTypeMatchModalController";
	...
	public void setUp() throws Exception
	{
		IntegrationTestUtil.importImpEx(
				...
				"                                   ; $ioCode ; ClassificationAttributeTypeEnum ; ClassificationAttributeTypeEnum ;                       ;                        "
		);
		integrationObjectModel = IntegrationObjectTestUtil.findIntegrationObjectByCode(IO_CODE);
	}
