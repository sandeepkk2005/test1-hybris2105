...
@IntegrationTest
class AttributeReadabilityIntegrationTest extends ServicelayerSpockSpecification {
    private static final String TEST_NAME    = "AttributeReadability"
    private static final String IO_NAME      = "${TEST_NAME}_EmployeeIO"
    private static final String EMPLOYEE_UID = "${TEST_NAME}_testIntegrationEmployee"
    private static final String GROUP_UID    = "${TEST_NAME}_testIntegrationGroup"
    ...
    def cleanup() {
        IntegrationTestUtil.remove IntegrationObjectModel, {io -> io.code == IO_NAME}
        IntegrationTestUtil.remove TestEmployeeModel, {employee -> employee.uid == EMPLOYEE_UID }
