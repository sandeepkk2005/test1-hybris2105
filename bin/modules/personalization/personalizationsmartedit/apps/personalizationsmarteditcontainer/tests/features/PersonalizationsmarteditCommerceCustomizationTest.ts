...
describe('personalizationsmarteditCommerceCustomizationViewController', () => {
	...
	let commerceCustomizationViewController: any;
	...
	beforeEach(() => {
		...
		const commerceCustomizationViewControllerFactory = PersonalizationsmarteditCommerceCustomizationViewControllerFactory(mockCustomization, mockVariation) as any;
