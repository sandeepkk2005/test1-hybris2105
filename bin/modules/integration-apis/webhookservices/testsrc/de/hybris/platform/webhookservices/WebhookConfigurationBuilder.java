...
public class WebhookConfigurationBuilder extends ExternalResource
{
	 ...
	 * Specifies integration object to be used for payload creation of the web hook notification
	 *
	 * @param builder an integration object builder specifying the integration object to be used by the webhook.
	 * @return a builder with the integration object specified
	 */
	public WebhookConfigurationBuilder withIntegrationObject(final IntegrationObjectModelBuilder builder)
	{
	...
	public WebhookConfigurationModel build() throws ImpExException
	{
		...
		final var ioCode = deriveIntegrationObjectCode();
		IntegrationTestUtil.importImpEx(
				...
				"                                  ;" + eventTypeValue + dest.getPk() + "             ; " + ioCode + "                        ; " + filterLocation);
	...
	private String deriveIntegrationObjectCode()
	{
		if (integrationObjectBuilder != null)
		{
			createdIntegrationObjects.add(integrationObjectBuilder);
			integrationObjectCode = integrationObjectBuilder.build().getCode();
			integrationObjectBuilder = null;
		}
