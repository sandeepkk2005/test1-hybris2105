...
@IntegrationTest
class ScriptServiceIntegrationTest extends ServicelayerSpockSpecification {
    private static final String TEST_NAME = 'ScriptService'
    private static final def SCRIPT_CODE = "${TEST_NAME}_TestScript"
    private static final def SCRIPT_DESCRIPTION = "${TEST_NAME}_TestDescription"
    ...
    @Shared
    @ClassRule
    ModuleEssentialData essentialData = IntegrationServicesEssentialData.integrationServicesEssentialData()
