...
import {PersonalizationsmarteditManagerViewControllerScope} from 'personalizationsmarteditcontainer/management/managerView/PersonalizationsmarteditManagerViewController';
...
describe('PersonalizationsmarteditManagerViewController', () => {
	...
	let $scope: jasmine.SpyObj<PersonalizationsmarteditManagerViewControllerScope>;
