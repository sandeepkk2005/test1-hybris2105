...
public final class OutboundSyncState
{
	...
	OutboundSyncState(final Integer allItems, final Date started, final int successes, final int errors, final int unprocessed,
	                  final Date ended,
	                  final boolean abort, final boolean systemError)
	{
