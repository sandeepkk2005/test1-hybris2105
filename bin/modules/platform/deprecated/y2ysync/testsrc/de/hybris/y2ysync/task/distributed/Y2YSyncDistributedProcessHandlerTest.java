...
public class Y2YSyncDistributedProcessHandlerTest extends ServicelayerBaseTest
{
	...
	{
		// given
		final Y2YSyncProcessCreationData creationData = Y2YSyncProcessCreationData.builder()
		                                                                          .withProcessId("TEST_PROCESS")
		                                                                          .withSyncType(Y2YSyncType.ZIP)
	...
	private Y2YDistributedProcessModel waitForDistributedImpEx(final String processCode)
	{
		do
		{
			try
			{
				final Y2YDistributedProcessModel process = (Y2YDistributedProcessModel) distributedProcessService.wait(
						processCode, 5);
