...
import de.hybris.platform.integrationservices.util.ClassificationAttributeUnitBuilder
import de.hybris.platform.integrationservices.util.ClassificationSystemBuilder
import de.hybris.platform.integrationservices.util.ClassificationSystemVersionBuilder
...
@IntegrationTest
class ClassificationPersistenceIntegrationTest extends ServicelayerSpockSpecification {

    private static final String TEST_NAME = 'ClassificationPersistence'
    private static final String CATALOG_VERSION = "${TEST_NAME}_testCatalogVersion"
    private static final String CATALOG_ID = "${TEST_NAME}_testCatalog"
    private static final String PRODUCT_CODE = "${TEST_NAME}_testProduct"
    private static final String PRODUCT_INTEGRATION_KEY = "$CATALOG_VERSION|$CATALOG_ID|$PRODUCT_CODE"
    private static final String PRODUCT_FEATURE_QUALIFIER = "${TEST_NAME}_testProductFeatureQualifier"
    ...
    def "product feature with unit classification is created"() {
        ...
        def catalogVersion = importCatalogVersion(CATALOG_VERSION, CATALOG_ID, true)
        ...
        featureIntegrationKeyAt(0, getResponse) == "$CATALOG_VERSION|${ClassificationSystemBuilder.ID}|$CATALOG_ID|${ClassificationAttributeUnitBuilder.CODE}|${ClassificationSystemVersionBuilder.VERSION}|$PRODUCT_FEATURE_QUALIFIER|$PRODUCT_FEATURE_VALUE_POSITION|$PRODUCT_CODE"
    }
    ...
    private static JsonBuilder product() {
        json()
                ...
                .withField("catalogVersion", catalogVersion(CATALOG_VERSION, CATALOG_ID))
    }
    ...
    private static JsonBuilder unit() {
        json()
                ...
                .withField('systemVersion', catalogVersion(ClassificationSystemVersionBuilder.VERSION, ClassificationSystemBuilder.ID))
    }
